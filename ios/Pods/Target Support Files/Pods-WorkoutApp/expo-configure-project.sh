...
with_node \
  ...
  --target "/Users/nwassom/Desktop/G23_WorkoutApp/ios/Pods/Target Support Files/Pods-WorkoutApp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-blur" "expo-constants" "expo-file-system" "expo-keep-awake" "expo-linear-gradient"
